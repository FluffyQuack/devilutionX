...
static void multi_clear_left_tbl() //If this returns true, then we proceed with simulating one tick of gameplay. This never returns false when playing singleplayer
{
	/*
